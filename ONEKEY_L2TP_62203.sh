...
-A INPUT -p udp -m multiport --dports 500,4500,62203 -j ACCEPT
...
EOF
            ...
            iptables -I INPUT -p udp -m multiport --dports 500,4500,62203 -j ACCEPT
...
EOF
    ...
    if [ $? -eq 0 ]; then
        ...
        firewall-cmd --permanent --add-port=62203/udp
        firewall-cmd --reload
    else
